...
# Define function to load RData files
...
# Load bigram, trigram, and quadgram frequencies data
bg <- load_RData("C:/Users/bfahs/Downloads/bigram.RData")
tg <- load_RData("C:/Users/bfahs/Downloads/trigram.RData")
qd <- load_RData("C:/Users/bfahs/Downloads/quadgram.RData")
